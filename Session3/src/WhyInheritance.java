...
class OneWayFlightBooking1 extends Booking{
	
	// in the Child, we must write additional attributes
	int travelers;
	int travelClass; // 1 -> economy, 2 business, 3 premium economy
	
	OneWayFlightBooking1(){	
		
	}
	
	// Parameterized Constructor -> Take input and than set the data
	OneWayFlightBooking1(String from, String to, String departureDate, int travelers, int travelClass){
...
public class WhyInheritance {
	...
	public static void main(String[] args) {
		...
		OneWayFlightBooking1 ofRef = new OneWayFlightBooking1("Delhi", "Bangalore", "15th Aug, 2020", 2, 1);
