...
class FileIOOperations{
	...
	void saveDataInFile(String data) {
		try {
			...
			File file = new File("C:\\Users\\neera\\Documents\\Customerdetails.csv");
			//if(file.exists())
	...
	void serialization(Customer customer) {
		try {
			...
			File file = new File("Documents"+customer.phone+".txt");
	...
	void deserialization(String phone) {
		try {
			...
			File file = new File("Documents"+phone+".txt");
		...
		while(true) {
			...
			switch (choice) {
				...
				case 3:
					...
					System.out.println("Enter the name of customer you want to mark exit: ");
					String customerName = scanner.nextLine();
					Date date1 = new Date(); // Date Object which is the time-stamp of our system
					cRef1.exitDateTime = date1.toString();
